  ...
  if (selectedOrder) {
    return (
      <div className="sriorder-details-wrapper">
        <button className="sriback-btn" onClick={handleBack}><RxCross2 /></button>
          ...
          <div className="sriicon-button" title="Records">
            ...
            {showDropdown && (
              <div className="sridropdown-menu">
                {[5, 10, 15, 20].map((num) => (
                  <div key={num} className="sridropdown-item" onClick={() => {
                    setNumRecords(num);
                    setCurrentPage(1);
                    setShowDropdown(false);
                  }}>{num}</div>
          ...
          <div className="sriicon-button" title="Share">
            ...
            {showShareOptions && (
              <div className="srishare-dropdown">
                <div className="srishare-item" onClick={() => {
                  exportToPDF();
                  setShowShareOptions(false);
                }}>
        ...
        {showFilter && (
          <div className="srifilter-form-wrapper">
            ...
            <div className="sriform-buttons">
              <button className="srisearch-btn" onClick={() => setCurrentPage(1)}>
                <IoMdSearch /> Search
              </button>
              <button
                className="sriclear-btn"
                onClick={() => {
                  setOrderIdFilter('');
                  setCustomerFilter('');
                  setCurrentPage(1);
