...
const ViewPromotion = () => {
  ...
  // const [ setItemsPerPage] = useState(5);
  // const [ setShowItemsPerPageDropdown] = useState(false);
  ...
  useEffect(() => {
    // In a real app, you would fetch the promotion data from an API
    const samplePromotions = [
      ...
      { id: 3, name: 'Summer Sale', type: 'Big', status: 'Active', description: 'Summer clearance sale' },
      ...
      { id: 6, name: 'Member Special', type: 'Small', status: 'Active', description: 'Exclusive deals for members' },
    ];
