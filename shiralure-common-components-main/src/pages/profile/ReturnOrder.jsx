...
const ReturnOrder = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!reason || !subReason) {
      alert("Please select both reason and sub-reason for return.");
      return;
    }
    alert("Return request submitted!");
    // Here you would handle the form data and uploaded images
  };
      ...
      <div className="main-scrollable">
        <div className="main">
          <form className="return-form" onSubmit={handleSubmit}>
            <h2 style={{ textAlign: "center", paddingBottom: "5px", color: "#d32f2f" }}>Return Your Order!</h2>

            <label className="form-label">
              Please select a reason for your return and provide details.
            </label>
            <select
              value={reason}
              onChange={(e) => {
